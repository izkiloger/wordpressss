<?php
/**
 * Title: Base Header with Mobile Always Menu With Top Bar
 * Slug: journal-notes/header-base-mobile-menu-top-bar
 * Categories: crosswinds-framework-header
 * Viewport Width: 1440
 */
?>

<!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"0"}},"className":"header-base-mobile-menu-top-bar","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull header-base-mobile-menu-top-bar"><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|xx-small","right":"var:preset|spacing|xx-small","bottom":"var:preset|spacing|xx-small","left":"var:preset|spacing|xx-small"}}},"backgroundColor":"contrast","textColor":"base","layout":{"type":"constrained","wideSize":"1440px"}} -->
