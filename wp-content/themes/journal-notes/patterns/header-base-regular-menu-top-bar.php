<?php
/**
 * Title: Base Header with Regular Menu With Top Bar
 * Slug: journal-notes/header-base-regular-menu-top-bar
 * Categories: crosswinds-framework-header
 * Viewport Width: 1440
 */
?>

<!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"0"}},"className":"header-base-regular-menu-top-bar","layout":{"type":"constrained"}} -->
