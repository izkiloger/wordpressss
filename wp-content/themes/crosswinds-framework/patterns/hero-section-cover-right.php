...
<div class="wp-block-column"><!-- wp:heading {"textAlign":"center","fontSize":"max-90","level":1} -->
<h1 class="wp-block-heading has-text-align-center has-max-90-font-size"><?php _e( 'This is a Heading', 'crosswinds-framework' ); ?></h1>
<!-- /wp:heading -->
