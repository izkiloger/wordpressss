...
<div class="wp-block-group last-bottom-layout cb-fill-height-parent" style="padding-top:var(--wp--preset--spacing--x-small);padding-right:var(--wp--preset--spacing--x-small);padding-bottom:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:heading {"textAlign":"center","level":3,"fontSize":"max-36"} -->
<h3 class="wp-block-heading has-text-align-center has-max-36-font-size"><?php _e( 'Person Name', 'crosswinds-framework' ); ?></h3>
<!-- /wp:heading -->
