...
<h1 class="wp-block-heading has-text-align-center has-max-72-font-size"><?php _e( 'Welcome to My Portfolio', 'crosswinds-framework' ); ?></h1>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-large-font-size"><?php _e( 'Studio Photography', 'crosswinds-framework' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"fontSize":"large","level":3} -->
<h3 class="wp-block-heading has-large-font-size"><?php _e( 'Photo Editing', 'crosswinds-framework' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"fontSize":"large","level":3} -->
<h3 class="wp-block-heading has-large-font-size"><?php _e( 'Storytelling', 'crosswinds-framework' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"fontSize":"large","level":3} -->
<h3 class="wp-block-heading has-large-font-size"><?php _e( 'Product Photgraphy', 'crosswinds-framework' ); ?></h3>
<!-- /wp:heading -->
